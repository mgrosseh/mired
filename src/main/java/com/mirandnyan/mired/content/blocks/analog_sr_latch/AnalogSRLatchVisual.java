...
public class AnalogSRLatchVisual extends AbstractBlockEntityVisual<AnalogSRLatchBlockEntity> implements SimpleDynamicVisual {
    ...
    public AnalogSRLatchVisual(VisualizationContext context, AnalogSRLatchBlockEntity blockEntity, float partialTick) {
        ...
        rY = AngleHelper.horizontalAngle(blockState.getValue(AnalogLeverBlock.FACING)) + 90;
